...
STATIC_HELP = [
    ...
    HelpEntry("Console", "run SECONDS", "Pause, advance by SECONDS immediately, stay paused"),
    ...
    HelpEntry("Console", "params", "Print the current parameter values"),
    ...
    HelpEntry("Console", "probe X Y", "Add a chart probe at a coordinate"),
    HelpEntry("Console", "deleteprobe X Y", "Delete the chart probe at a coordinate"),
]
